...
urfuncs[1799] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"f",f:sb,a:cons({c:"f",f:ss,a:cons({c:"v",n:1},null)},cons({c:"l",b:{c:"f",f:sr,a:cons({c:"f",f:ts,a:cons({c:".",r:{c:"v",n:0},f:"Count"},null)},null)}},null))}}}'};
urfuncs[1800] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"=",e1:{c:"f",f:uw_mouseEvent,a:null},e2:{c:"=",e1:{c:"f",f:sg,a:cons({c:"v",n:2},null)},e2:{c:"f",f:sv,a:cons({c:"v",n:3},cons({c:"r",l:cons({n:"Count",v:{c:"f",f:plus,a:cons({c:".",r:{c:"v",n:0},f:"Count"},cons({c:"c",v:1},null))}},cons({n:"Show",v:{c:".",r:{c:"v",n:0},f:"Show"}},null))},null))}}}}}'};
urfuncs[1801] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"=",e1:{c:"f",f:uw_mouseEvent,a:null},e2:{c:"=",e1:{c:"f",f:sg,a:cons({c:"v",n:2},null)},e2:{c:"f",f:sv,a:cons({c:"v",n:3},cons({c:"r",l:cons({n:"Count",v:{c:"f",f:minus,a:cons({c:".",r:{c:"v",n:0},f:"Count"},cons({c:"c",v:1},null))}},cons({n:"Show",v:{c:".",r:{c:"v",n:0},f:"Show"}},null))},null))}}}}}'};
urfuncs[1802] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"=",e1:{c:"f",f:uw_mouseEvent,a:null},e2:{c:"=",e1:{c:"f",f:sg,a:cons({c:"v",n:2},null)},e2:{c:"f",f:sv,a:cons({c:"v",n:3},cons({c:"r",l:cons({n:"Count",v:{c:".",r:{c:"v",n:0},f:"Count"}},cons({n:"Show",v:{c:"c",v:false}},null))},null))}}}}}'};
urfuncs[1791] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"m",e:{c:"v",n:0},p:cons({p:{c:"c",v:null},b:{c:"v",n:1}},cons({p:{c:"s",n:false,p:{c:"r",l:cons({n:"1",p:{/*hoho*/c:"v"}},cons({n:"2",p:{/*hoho*/c:"v"}},null))}},b:{c:"a",f:{c:"a",f:{c:"n",n:1791},x:{c:"r",l:cons({n:"1",v:{c:"v",n:1}},cons({n:"2",v:{c:"v",n:3}},null))}},x:{c:"v",n:0}}},null))}}}'};
urfuncs[1796] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"l",b:{c:"m",e:{c:"v",n:1},p:cons({p:{c:"c",v:null},b:{c:"a",f:{c:"a",f:{c:"n",n:1791},x:{c:"c",v:null}},x:{c:"v",n:2}}},cons({p:{c:"s",n:false,p:{c:"r",l:cons({n:"1",p:{/*hoho*/c:"v"}},cons({n:"2",p:{/*hoho*/c:"v"}},null))}},b:{c:"a",f:{c:"a",f:{c:"a",f:{c:"n",n:1796},x:{c:"m",e:{c:"f",f:not,a:cons({c:"f",f:eq,a:cons({c:".",r:{c:"f",f:sg,a:cons({c:"v",n:1},null)},f:"Show"},cons({c:"c",v:false},null))},null)},p:cons({p:{c:"c",v:true},b:{c:"r",l:cons({n:"1",v:{c:"v",n:1}},cons({n:"2",v:{c:"v",n:4}},null))}},cons({p:{c:"c",v:false},b:{c:"v",n:4}},null))}},x:{c:"v",n:0}},x:{c:"c",v:null}}},null))}}}}'};
urfuncs[1803] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"=",e1:{c:"f",f:uw_mouseEvent,a:null},e2:{c:"=",e1:{c:"a",f:{c:"a",f:{c:"a",f:{c:"n",n:1796},x:{c:"c",v:null}},x:{c:"f",f:sg,a:cons({c:"v",n:2},null)}},x:{c:"c",v:null}},e2:{c:"=",e1:{c:"f",f:sc,a:cons({c:"r",l:cons({n:"Count",v:{c:"c",v:0}},cons({n:"Show",v:{c:"c",v:true}},null))},null)},e2:{c:"f",f:sv,a:cons({c:"v",n:4},cons({c:"r",l:cons({n:"1",v:{c:"v",n:0}},cons({n:"2",v:{c:"v",n:1}},null))},null))}}}}}}'};
urfuncs[1797] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"m",e:{c:"v",n:0},p:cons({p:{c:"c",v:null},b:{c:"f",f:sr,a:cons({c:"a",f:{c:"a",f:{c:"n",n:1791},x:{c:"c",v:null}},x:{c:"v",n:1}},null)}},cons({p:{c:"s",n:false,p:{c:"r",l:cons({n:"1",p:{/*hoho*/c:"v"}},cons({n:"2",p:{/*hoho*/c:"v"}},null))}},b:{c:"f",f:sb,a:cons({c:"f",f:sb,a:cons({c:"f",f:ss,a:cons({c:"v",n:1},null)},cons({c:"l",b:{c:"f",f:sr,a:cons({c:"f",f:not,a:cons({c:"f",f:eq,a:cons({c:".",r:{c:"v",n:0},f:"Show"},cons({c:"c",v:false},null))},null)},null)}},null))},cons({c:"l",b:{c:"a",f:{c:"a",f:{c:"n",n:1797},x:{c:"m",e:{c:"v",n:0},p:cons({p:{c:"c",v:true},b:{c:"r",l:cons({n:"1",v:{c:"v",n:2}},cons({n:"2",v:{c:"v",n:4}},null))}},cons({p:{c:"c",v:false},b:{c:"v",n:4}},null))}},x:{c:"v",n:1}}},null))}},null))}}}'};
urfuncs[1798] = {c:"t",f:'{c:"l",b:{c:"m",e:{c:"v",n:0},p:cons({p:{c:"c",v:null},b:{c:"c",v:""}},cons({p:{c:"s",n:false,p:{c:"r",l:cons({n:"1",p:{/*hoho*/c:"v"}},cons({n:"2",p:{/*hoho*/c:"v"}},null))}},b:{c:"f",f:cat,a:cons({c:"c",v:"\\n\\074script type=\\"text/javascript\\">dyn(\\"span\\", execD("},cons({c:"f",f:cat,a:cons({c:"e",e:{c:"a",f:{c:"a",f:{c:"n",n:1799},x:{c:"v",n:1}},x:{c:"c",v:null}}},cons({c:"f",f:cat,a:cons({c:"c",v:"))\\074/script>\\074br />\\n\\074button onclick=\'uw_event=event;exec("},cons({c:"f",f:cat,a:cons({c:"e",e:{c:"a",f:{c:"a",f:{c:"n",n:1800},x:{c:"v",n:1}},x:{c:"c",v:null}}},cons({c:"f",f:cat,a:cons({c:"c",v:")\'>Incr\\074/button>\\n\\074button onclick=\'uw_event=event;exec("},cons({c:"f",f:cat,a:cons({c:"e",e:{c:"a",f:{c:"a",f:{c:"n",n:1801},x:{c:"v",n:1}},x:{c:"c",v:null}}},cons({c:"f",f:cat,a:cons({c:"c",v:")\'>Decr\\074/button>\\n\\074button onclick=\'uw_event=event;exec("},cons({c:"f",f:cat,a:cons({c:"e",e:{c:"a",f:{c:"a",f:{c:"n",n:1802},x:{c:"v",n:1}},x:{c:"c",v:null}}},cons({c:"f",f:cat,a:cons({c:"c",v:")\'>Del\\074/button>\\074br />\\n"},cons({c:"a",f:{c:"n",n:1798},x:{c:"v",n:0}},null))},null))},null))},null))},null))},null))},null))},null))},null))}},null))}}'};
urfuncs[1804] = {c:"t",f:'{c:"l",b:{c:"l",b:{c:"f",f:sb,a:cons({c:"f",f:ss,a:cons({c:"v",n:1},null)},cons({c:"l",b:{c:"=",e1:{c:"a",f:{c:"a",f:{c:"n",n:1797},x:{c:"c",v:null}},x:{c:"v",n:0}},e2:{c:"f",f:sb,a:cons({c:"v",n:0},cons({c:"l",b:{c:"f",f:sr,a:cons({c:"a",f:{c:"n",n:1798},x:{c:"a",f:{c:"a",f:{c:"n",n:1791},x:{c:"c",v:null}},x:{c:"v",n:0}}},null)}},null))}}},null))}}}'};
